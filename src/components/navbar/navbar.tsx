  ...
  return (
    ...
    >
      <div className="lg:px-16 h-14 flex justify-around border-b border-border/40 items-center flex-row">
        <div className="flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-t w-24 h-8 from-royal-blue-500 to-royal-blue-600 shadow-lg shadow-royal-blue-500/50 dark:shadow-royal-blue-800/50 hover:bg-gradient-to-t hover:from-royal-blue-600 hover:to-royal-blue-700 rounded-md animate-pulse">
