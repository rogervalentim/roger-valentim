    ...
    >
      ...
      <div className="flex justify-center mt-5">
        <a href={curriculum} target="_blank">
          <Button
            type="button"
            className="w-64 font-bold flex gap-2 mt-4 text-royal-blue-950 bg-gradient-to-t shadow-lg shadow-royal-blue-500/50 dark:shadow-royal-blue-800/50 from-royal-blue-500 to-royal-blue-600 hover:bg-gradient-to-t hover:from-royal-blue-600 hover:to-royal-blue-700"
          >
            {t("cv")}
